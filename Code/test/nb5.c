...
void update_fnd(int number) {
    ...
    fnd_data[3] = 0x3F & ~0x01; // FND에 표시할 값 (예: 숫자 1)
    fnd_data[2] = 0x06 & ~0x01; // FND에 표시할 값 (예: 숫자 2)
    fnd_data[1] = 0x5B & ~0x01; // FND에 표시할 값 (예: 숫자 3)
    fnd_data[0] = 0x4F & ~0x01; // FND에 표시할 값 (예: 숫자 4)
    fnd_data[3] = 0x3F & ~0x01; // FND에 표시할 값 (예: 숫자 0)
